...
// Payment routes
$router->addRoute('GET', '/payments', 'PaymentController', 'index');
$router->addRoute('GET', '/payments/create', 'PaymentController', 'create');
$router->addRoute('POST', '/payments/create', 'PaymentController', 'create');
$router->addRoute('POST', '/payments/delete', 'PaymentController', 'delete');
